...
IF OBJECT_ID('dbo.debtors_select_all_addresses', 'P') IS NOT NULL
    DROP PROCEDURE dbo.debtors_select_all_addresses;
GO

CREATE PROCEDURE dbo.debtors_select_all_addresses
@DebtorID INT
AS
BEGIN
...
ON (d.DebtorID = ea.EntityRecordID)
