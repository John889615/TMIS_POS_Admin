...
BEGIN
    ...
    INSERT INTO POS_StockRequestLines (FK_StockRequestID, FK_ProductID, Quantity, Notes, ManagerNotes, IsDeclined, ApprovedQuantity)
    OUTPUT INSERTED.StockRequestLineID INTO @Inserted
    VALUES (@FK_StockRequestID, @FK_ProductID, @Quantity, @Notes, @ManagerNotes, @IsDeclined, @ApprovedQuantity);
