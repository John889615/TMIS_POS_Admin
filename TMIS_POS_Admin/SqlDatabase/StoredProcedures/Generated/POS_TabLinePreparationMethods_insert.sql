...
BEGIN
    ...
    INSERT INTO POS_TabLinePreparationMethods (FK_TabLineCombinationID, FK_PreparationMethodID, PreparationMethodName)
    OUTPUT INSERTED.TabLinePreparationMethodID INTO @Inserted
    VALUES (@FK_TabLineCombinationID, @FK_PreparationMethodID, @PreparationMethodName);
