import {
  _iterableToArray,
  _toConsumableArray
} from "./chunk-5KDBJYPV.js";
import {
  canUseDom,
  warning_default
} from "./chunk-I75PET4F.js";
import {
  _arrayWithHoles,
  _nonIterableRest,
...
} from "./chunk-K3NIW5W3.js";
import {
  _defineProperty,
  _objectSpread2,
  _typeof
} from "./chunk-337ZE2A4.js";
import {
  require_classnames
...
function useDrag(containerRef, direction, rawValues, min, max, formatValue, triggerChange, finishChange, offsetValues) {
  ...
  var _React$useState5 = React13.useState(rawValues), _React$useState6 = _slicedToArray(_React$useState5, 2), cacheValues = _React$useState6[0], setCacheValues = _React$useState6[1];
  var _React$useState7 = React13.useState(rawValues), _React$useState8 = _slicedToArray(_React$useState7, 2), originValues = _React$useState8[0], setOriginValues = _React$useState8[1];
...
var Slider = React15.forwardRef(function(props, ref) {
  ...
  }), React15.createElement(Tracks_default, {
    prefixCls,
    style: trackStyle,
...
//# sourceMappingURL=chunk-ANL65J4K.js.map
