...
var PrimeReactChart = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var chartRef = React4.useRef(null);
  var canvasRef = React4.useRef(null);
  var initChart = function initChart2() {
    ...
    if (ChartJS) {
      ...
      import("./auto-LDXNIH27.js").then(function(module) {
        destroyChart();
  ...
  return React4.createElement("div", rootProps, React4.createElement("canvas", canvasProps));
