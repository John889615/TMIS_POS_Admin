...
const EntityDataCountryProvince = () => {
    ...
    const fetchAddresses = async () => {
        try {
            const data = await getAllCountryProvince();
            setAddressList(data);
        } catch (err) {
                ...
                <div className="page-header">
                    <div className="add-item d-flex">
                        <div className="page-title">
                            <h4>Country Provinces</h4>
                            <h6>Manage Your Provinces</h6>
                        </div>
                    </div>
...
export default EntityDataCountryProvince;
