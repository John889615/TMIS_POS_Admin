export const all_routes = {
  ...
  entityDataAddress: "/entity-data-address",
  entityDataAddressRegion: "/entity-data-address-region",
  entityDataAddressType: "/entity-data-address-type",
  entityDataContact: "/entity-data-contact",
  entityDataContactType: "/entity-data-contact-type",
  entityDataContinent: "/entity-data-continent",
  entityDataCountry: "/countries",
  entityDataCountryProvince: "/country-province",
  entityDataCountryRegion: "/country-region",
  entityDataCountrySubRegion: "/country-sub-region",
  entityDataCurrencies: "/currencies",
  entityDataDialingCode: "/dialing-code",
  entityDataEntities: "/entities",
  entityDataEntitiesAddress: "/entity-address",
  entityDataEntitiesContact: "/entity-contact",
  entityDataStatus: "/status",
  entityDataStatusGroup: "/status-group",
  entityDataTimeZone: "/time-zone",
  debtor: "/debtors",
  debtorType: "/debtor-type",
  // debtorAddress: "/debtor-address",
  debtorBranch: "/debtor-branch",
  debtorDepartment: "/debtor-department",
  debtorAddressType: "/debtor-address-type",
  costCenter: "/cost-center",
  debtorcostCenterType: "/cost-center-type",
  creditors: "/creditor",
  productUnit: "/product-units",
  productCategory: "/product-category",
  productType: "/product-type",
  products: "/products",
  productCombination: "/product-combination/:id",
  productServedAs: "/product-served-as/:id",
  productExtra: "/product-extra/:id",
  productPreparation: "/product-preparation/:id",
  productSubstitution: "/product-substitution/:id",
  productExtraCategory: "/extra-category",
  productPreparationMethod: "/prep-method",
  servedAs: "/served-as",
  ...
  menutreeCamp: "/menu-tree-camp/:id",
  placeorder: "/place-order",
  entitySlipPrinter: "/slip-printer",
  entityPaymentType: "/payment-type",
  entityTaxType: "/tax-type",
  stockdebtorproduct: "location-product",
  debtorProductPrice: "/debtor-product-price/:id",
  stockCostCenterproduct: "cost-center-product",
  priceCode: "/price-code",
  BcSyncPage: "/BcSyncPage",
  BcInvoicingPage: "/BcInvoicingPage",
