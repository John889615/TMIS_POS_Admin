...
const ProductForm = ({
  ...
  const handleSubmit = (e) => {
    ...
    const productData = {
      ...
      FK_ProductTypeID: form.FK_ProductTypeID.value
        ? parseInt(form.FK_ProductTypeID.value)
        : null,
      IsStockTracked: form.IsStockTracked.checked,
      FK_UnitID: form.FK_UnitID.value ? parseInt(form.FK_UnitID.value) : null,
      FK_DefaultUnitID: form.FK_DefaultUnitID.value
        ? parseInt(form.FK_DefaultUnitID.value)
        : null,
      FK_ProductCategoryID: form.FK_ProductCategoryID.value
        ? parseInt(form.FK_ProductCategoryID.value)
        : null,
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="input-blocks">
                ...
                <select
                  ...
                  required
                  defaultValue={data?.FK_ProductTypeID || ""}
                >
            ...
            <div className="col-lg-6">
              <div className="input-blocks">
                ...
                <select
                  name="FK_DefaultUnitID"
                  className="form-select"
                  required
                  defaultValue={data?.FK_DefaultUnitID || ""}
                >
                  <option value="">Please select..</option>
                  {unitList.map((item, index) => (
                    <option key={index} value={item.POS_UnitID}>
            ...
            <div className="col-lg-6">
              <div className="input-blocks">
                ...
                <select
                  ...
                  className="form-select"
                  required
                  defaultValue={data?.FK_ProductCategoryID || ""}
                >
                  <option value="">Please select..</option>
