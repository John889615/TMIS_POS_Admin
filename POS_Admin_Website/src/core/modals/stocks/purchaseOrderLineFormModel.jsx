...
const PurchaseOrderLineForm = ({
    ...
    const handleSubmit = (e) => {
        ...
        const purchaseDataLine = {
            POS_PurchaseOrderLineID: null, // Use 0 instead of null if API requires number
            FK_PurchaseOrderID: form.FK_PurchaseOrderID.value
                ? parseInt(form.FK_PurchaseOrderID.value)
                : 0,
        ...
        const payload = {
            PurchaseOrderLines: [purchaseDataLine], // ✅ Wrap in array and key
        };
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="input-blocks">
                                ...
                                <select name="FK_PurchaseOrderID" required className="form-select" defaultValue={data?.FK_PurchaseOrderID || ''}>
...
PurchaseOrderLineForm.propTypes = {
