...
import { getAllEntityContact } from "../../../services/entityData/entityContact";
...
const EntityDataEntityContact = () => {
    ...
    const fetchAddresses = async () => {
        try {
            const data = await getAllEntityContact();
            setAddressList(data);
        } catch (err) {
                ...
                <div className="page-header">
                    <div className="add-item d-flex">
                        <div className="page-title">
                            <h4>Entity Contacts</h4>
                            <h6>Manage Your Entity Contact</h6>
                        </div>
                    </div>
...
export default EntityDataEntityContact;
