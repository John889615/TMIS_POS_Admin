            ...
            try
            {
                        ...
                        new SqlParameter() { DbType = DbType.Guid, Direction = ParameterDirection.Input, ParameterName = "@InvoicePaymentID", Value = item.InvoicePaymentID }                ))
                {
                    if (reader.HasRows)
                    {
                        ...
                        Log.Information("InvoicePayment found: InvoicePaymentID={InvoicePaymentID}, FK_InvoiceID={FK_InvoiceID}, FK_PaymentTypeID={FK_PaymentTypeID}, FK_FromCurrencyID={FK_FromCurrencyID}, FK_ToCurrencyID={FK_ToCurrencyID}, FromCurrency={FromCurrency}, ToCurrency={ToCurrency}, FromTotal={FromTotal}, ToTotal={ToTotal}, FromAmountPaid={FromAmountPaid}, ToAmountPaid={ToAmountPaid}, ExchangeRate={ExchangeRate}, ExchangeDate={ExchangeDate}, DatePaid={DatePaid}", resultItem.InvoicePaymentID, resultItem.FK_InvoiceID, resultItem.FK_PaymentTypeID, resultItem.FK_FromCurrencyID, resultItem.FK_ToCurrencyID, resultItem.FromCurrency, resultItem.ToCurrency, resultItem.FromTotal, resultItem.ToTotal, resultItem.FromAmountPaid, resultItem.ToAmountPaid, resultItem.ExchangeRate, resultItem.ExchangeDate, resultItem.DatePaid);
                        return resultItem;
                    }
                    else
                    {
            ...
            try
            {
                ...
                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    ...
                    "POS_InvoicePayments_insert",
                        ...
                        , new SqlParameter() { DbType = DbType.String, Direction = ParameterDirection.Input, ParameterName = "@FromCurrency", Value = item.FromCurrency }
                        , new SqlParameter() { DbType = DbType.String, Direction = ParameterDirection.Input, ParameterName = "@ToCurrency", Value = item.ToCurrency }
                        , new SqlParameter() { DbType = DbType.Decimal, Direction = ParameterDirection.Input, ParameterName = "@FromTotal", Value = item.FromTotal }
                        , new SqlParameter() { DbType = DbType.Decimal, Direction = ParameterDirection.Input, ParameterName = "@ToTotal", Value = item.ToTotal }
                        , new SqlParameter() { DbType = DbType.Decimal, Direction = ParameterDirection.Input, ParameterName = "@FromAmountPaid", Value = item.FromAmountPaid }
                        , new SqlParameter() { DbType = DbType.Decimal, Direction = ParameterDirection.Input, ParameterName = "@ToAmountPaid", Value = item.ToAmountPaid }
            ...
            try
            {
                ...
                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    ...
                    "POS_TabLines_insert",
                        ...
                        , new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@DiscountPerc", Value = item.DiscountPerc }
            ...
            try
            {
                ...
                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    ...
                    "POS_TablineSubstitutes_select_single",
                        new SqlParameter() { DbType = DbType.Guid, Direction = ParameterDirection.Input, ParameterName = "@POS_TablineSubstituteID", Value = item.POS_TablineSubstituteID }                ))
                {
                    if (reader.HasRows)
                    {
                        resultItem = await reader.TranslateSingleAsync<TabLineSubstitute>(Sync_Translator.Translate_TabLineSubstitute);
                        Log.Information("TabLineSubstitute found: POS_TablineSubstituteID={POS_TablineSubstituteID}, FK_ParentTabLineID={FK_ParentTabLineID}, FK_SubstituionTabLineID={FK_SubstituionTabLineID}, FK_ParentTabLineCombinationID={FK_ParentTabLineCombinationID}", resultItem.POS_TablineSubstituteID, resultItem.FK_ParentTabLineID, resultItem.FK_SubstituionTabLineID, resultItem.FK_ParentTabLineCombinationID);
                        return resultItem;
                    }
                    else
                    {
            ...
            try
            {
                ...
                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    ...
                    "POS_Tabs_insert",
                        ...
                        , new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@GratuityPerc", Value = item.GratuityPerc }
                        , new SqlParameter() { DbType = DbType.Decimal, Direction = ParameterDirection.Input, ParameterName = "@Discount", Value = item.Discount }
                        , new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@DiscountPerc", Value = item.DiscountPerc }
                        , new SqlParameter() { DbType = DbType.Boolean, Direction = ParameterDirection.Input, ParameterName = "@IsVoided", Value = item.IsVoided }
