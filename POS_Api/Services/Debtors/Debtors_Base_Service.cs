...
namespace POS_Api.Services.Debtors
{
    public abstract class Debtors_Base_Service
    {
        ...
        public static async Task<Branch> Branches_Select_Single_Transaction(Branch item, string connectionString)
        {
            try
            {
                ...
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
                {
                    ...
                    var result = await Branches_Select_Single(item, sqlConn);
        ...
        public static async Task<Branch> Branches_Select_Single(Branch item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Branch> Branches_Select_Single(Branch item, SqlConnection sqlConn)
        {
            try
            {
                Branch resultItem = null;

                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    sqlConn,
                    "Branches_select_single",
                        new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@BranchID", Value = item.BranchID }                ))
                {
                    if (reader.HasRows)
                    {
                        resultItem = await reader.TranslateSingleAsync<Branch>(Debtors_Translator.Translate_Branch);
                        Log.Information("Branch found: BranchID={BranchID}, ShortCode={ShortCode}, Name={Name}, FK_StatusID={FK_StatusID}, DateCreated={DateCreated}, DateUpdated={DateUpdated}", resultItem.BranchID, resultItem.ShortCode, resultItem.Name, resultItem.FK_StatusID, resultItem.DateCreated, resultItem.DateUpdated);
                        return resultItem;
                    }
                    else
                    {
                        Log.Warning("No Branch found with the given BranchID.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<Branch> Branches_Insert_Transaction(Branch item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Branches_Insert(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<Branch> Branches_Insert(Branch item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Branch> Branches_Insert(Branch item, SqlConnection sqlConn)
        {
            try
            {
                Branch resultItem = null;
                        ...
                        , new SqlParameter() { DbType = DbType.DateTime, Direction = ParameterDirection.Input, ParameterName = "@DateUpdated", Value = item.DateUpdated }                ))
                {
                    ...
                    {
                        Log.Warning("Branch failed to create.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<List<Branch>> Branches_Select_All_Transaction(Branch item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Branches_Select_All(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<List<Branch>> Branches_Select_All(Branch item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<List<Branch>> Branches_Select_All(Branch item, SqlConnection sqlConn)
        {
            try
            {
                List<Branch> resultItem = new List<Branch>();
                    ...
                    null))
                {
                    if (reader.HasRows)
                    {
                        resultItem.AddRange(await reader.TranslateAsync<Branch>(Debtors_Translator.Translate_Branch));
                        Log.Information("Branch records found: {Count}", resultItem.Count);
                        return resultItem;
                    }
                    else
                    {
                        Log.Warning("No Branch records found.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<Branch> Branches_Update_Transaction(Branch item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Branches_Update(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<Branch> Branches_Update(Branch item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Branch> Branches_Update(Branch item, SqlConnection sqlConn)
        {
            try
            {
                Branch resultItem = null;
                        ...
                        , new SqlParameter() { DbType = DbType.DateTime, Direction = ParameterDirection.Input, ParameterName = "@DateUpdated", Value = item.DateUpdated }                ))
                {
                    ...
                    {
                        Log.Warning("Branch failed to update.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<Debtor> Debtors_Select_Single_Transaction(Debtor item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Debtors_Select_Single(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<Debtor> Debtors_Select_Single(Debtor item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Debtor> Debtors_Select_Single(Debtor item, SqlConnection sqlConn)
        {
            try
            {
        ...
        public static async Task<Debtor> Debtors_Insert_Transaction(Debtor item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Debtors_Insert(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<Debtor> Debtors_Insert(Debtor item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Debtor> Debtors_Insert(Debtor item, SqlConnection sqlConn)
        {
            try
            {
                Debtor resultItem = null;
        ...
        public static async Task<List<Debtor>> Debtors_Select_All_Transaction(Debtor item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Debtors_Select_All(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<List<Debtor>> Debtors_Select_All(Debtor item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<List<Debtor>> Debtors_Select_All(Debtor item, SqlConnection sqlConn)
        {
            try
            {
                    ...
                    null))
                {
                    if (reader.HasRows)
                    {
                        resultItem.AddRange(await reader.TranslateAsync<Debtor>(Debtors_Translator.Translate_Debtor));
                        Log.Information("Debtor records found: {Count}", resultItem.Count);
                        return resultItem;
                    }
                    else
                    {
        ...
        public static async Task<Debtor> Debtors_Update_Transaction(Debtor item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Debtors_Update(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<Debtor> Debtors_Update(Debtor item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Debtor> Debtors_Update(Debtor item, SqlConnection sqlConn)
        {
            try
            {
                Debtor resultItem = null;
                        ...
                        , new SqlParameter() { DbType = DbType.String, Direction = ParameterDirection.Input, ParameterName = "@BC_ID", Value = item.BC_ID }                ))
                {
                    ...
                    {
                        Log.Warning("Debtor failed to update.");
                        return default;
                    }
                }
            }
        ...
        #region DebtorTypeMappings

        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Select_Single_Transaction(DebtorTypeMapping item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await DebtorTypeMappings_Select_Single(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Select_Single(DebtorTypeMapping item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Select_Single(DebtorTypeMapping item, SqlConnection sqlConn)
        {
            try
            {
                DebtorTypeMapping resultItem = null;

                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    sqlConn,
                    "DebtorTypeMappings_select_single",
                        new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@DebtorTypeMappingID", Value = item.DebtorTypeMappingID }                ))
                {
                    if (reader.HasRows)
                    {
                        resultItem = await reader.TranslateSingleAsync<DebtorTypeMapping>(Debtors_Translator.Translate_DebtorTypeMapping);
                        Log.Information("DebtorTypeMapping found: DebtorTypeMappingID={DebtorTypeMappingID}, FK_DebtorID={FK_DebtorID}, FK_DebtorTypeID={FK_DebtorTypeID}, FK_StatusID={FK_StatusID}, FK_BranchID={FK_BranchID}, FK_DepartmentID={FK_DepartmentID}, DateCreated={DateCreated}, DateUpdated={DateUpdated}", resultItem.DebtorTypeMappingID, resultItem.FK_DebtorID, resultItem.FK_DebtorTypeID, resultItem.FK_StatusID, resultItem.FK_BranchID, resultItem.FK_DepartmentID, resultItem.DateCreated, resultItem.DateUpdated);
                        return resultItem;
                    }
                    else
                    {
                        Log.Warning("No DebtorTypeMapping found with the given DebtorTypeMappingID.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Insert_Transaction(DebtorTypeMapping item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await DebtorTypeMappings_Insert(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Insert(DebtorTypeMapping item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Insert(DebtorTypeMapping item, SqlConnection sqlConn)
        {
            try
            {
                DebtorTypeMapping resultItem = null;
                ...
                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    sqlConn,
                    "DebtorTypeMappings_insert",
                        new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@FK_DebtorID", Value = item.FK_DebtorID }
                        , new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@FK_DebtorTypeID", Value = item.FK_DebtorTypeID }
                        , new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@FK_StatusID", Value = item.FK_StatusID }
                        ...
                        , new SqlParameter() { DbType = DbType.DateTime, Direction = ParameterDirection.Input, ParameterName = "@DateUpdated", Value = item.DateUpdated }                ))
                {
                    ...
                    {
                        Log.Warning("DebtorTypeMapping failed to create.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<List<DebtorTypeMapping>> DebtorTypeMappings_Select_All_Transaction(DebtorTypeMapping item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await DebtorTypeMappings_Select_All(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<List<DebtorTypeMapping>> DebtorTypeMappings_Select_All(DebtorTypeMapping item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<List<DebtorTypeMapping>> DebtorTypeMappings_Select_All(DebtorTypeMapping item, SqlConnection sqlConn)
        {
            try
            {
                List<DebtorTypeMapping> resultItem = new List<DebtorTypeMapping>();

                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    sqlConn,
                    "DebtorTypeMappings_select_all",
                    null))
                {
                    if (reader.HasRows)
                    {
                        resultItem.AddRange(await reader.TranslateAsync<DebtorTypeMapping>(Debtors_Translator.Translate_DebtorTypeMapping));
                        Log.Information("DebtorTypeMapping records found: {Count}", resultItem.Count);
                        return resultItem;
                    }
                    else
                    {
                        Log.Warning("No DebtorTypeMapping records found.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Update_Transaction(DebtorTypeMapping item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await DebtorTypeMappings_Update(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Update(DebtorTypeMapping item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<DebtorTypeMapping> DebtorTypeMappings_Update(DebtorTypeMapping item, SqlConnection sqlConn)
        {
            try
            {
                DebtorTypeMapping resultItem = null;
                        ...
                        , new SqlParameter() { DbType = DbType.DateTime, Direction = ParameterDirection.Input, ParameterName = "@DateUpdated", Value = item.DateUpdated }                ))
                {
                    ...
                    {
                        Log.Warning("DebtorTypeMapping failed to update.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<DebtorType> DebtorTypes_Select_Single_Transaction(DebtorType item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await DebtorTypes_Select_Single(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<DebtorType> DebtorTypes_Select_Single(DebtorType item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<DebtorType> DebtorTypes_Select_Single(DebtorType item, SqlConnection sqlConn)
        {
            try
            {
                DebtorType resultItem = null;

                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    sqlConn,
                    "DebtorTypes_select_single",
                        new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@DebtorTypeID", Value = item.DebtorTypeID }                ))
                {
                    if (reader.HasRows)
                    {
                        resultItem = await reader.TranslateSingleAsync<DebtorType>(Debtors_Translator.Translate_DebtorType);
                        Log.Information("DebtorType found: DebtorTypeID={DebtorTypeID}, Type={Type}, Description={Description}, DateCreated={DateCreated}, DateUpdated={DateUpdated}", resultItem.DebtorTypeID, resultItem.Type, resultItem.Description, resultItem.DateCreated, resultItem.DateUpdated);
                        return resultItem;
                    }
                    else
                    {
                        Log.Warning("No DebtorType found with the given DebtorTypeID.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<DebtorType> DebtorTypes_Insert_Transaction(DebtorType item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await DebtorTypes_Insert(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<DebtorType> DebtorTypes_Insert(DebtorType item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<DebtorType> DebtorTypes_Insert(DebtorType item, SqlConnection sqlConn)
        {
            try
            {
                DebtorType resultItem = null;
                        ...
                        , new SqlParameter() { DbType = DbType.DateTime, Direction = ParameterDirection.Input, ParameterName = "@DateUpdated", Value = item.DateUpdated }                ))
                {
                    ...
                    {
                        Log.Warning("DebtorType failed to create.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<List<DebtorType>> DebtorTypes_Select_All_Transaction(DebtorType item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await DebtorTypes_Select_All(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<List<DebtorType>> DebtorTypes_Select_All(DebtorType item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<List<DebtorType>> DebtorTypes_Select_All(DebtorType item, SqlConnection sqlConn)
        {
            try
            {
                List<DebtorType> resultItem = new List<DebtorType>();

                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    sqlConn,
                    "DebtorTypes_select_all",
                    null))
                {
                    if (reader.HasRows)
                    {
                        resultItem.AddRange(await reader.TranslateAsync<DebtorType>(Debtors_Translator.Translate_DebtorType));
                        Log.Information("DebtorType records found: {Count}", resultItem.Count);
                        return resultItem;
                    }
                    else
                    {
                        Log.Warning("No DebtorType records found.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<DebtorType> DebtorTypes_Update_Transaction(DebtorType item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await DebtorTypes_Update(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<DebtorType> DebtorTypes_Update(DebtorType item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<DebtorType> DebtorTypes_Update(DebtorType item, SqlConnection sqlConn)
        {
            try
            {
                DebtorType resultItem = null;
                        ...
                        , new SqlParameter() { DbType = DbType.DateTime, Direction = ParameterDirection.Input, ParameterName = "@DateUpdated", Value = item.DateUpdated }                ))
                {
                    ...
                    {
                        Log.Warning("DebtorType failed to update.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<Department> Departments_Select_Single_Transaction(Department item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Departments_Select_Single(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<Department> Departments_Select_Single(Department item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Department> Departments_Select_Single(Department item, SqlConnection sqlConn)
        {
            try
            {
                Department resultItem = null;

                using (var reader = await SqlClient.ExecuteReaderStoredProcedureAsync(
                    sqlConn,
                    "Departments_select_single",
                        new SqlParameter() { DbType = DbType.Int32, Direction = ParameterDirection.Input, ParameterName = "@DepartmentID", Value = item.DepartmentID }                ))
                {
                    if (reader.HasRows)
                    {
                        resultItem = await reader.TranslateSingleAsync<Department>(Debtors_Translator.Translate_Department);
                        Log.Information("Department found: DepartmentID={DepartmentID}, ShortCode={ShortCode}, Name={Name}, FK_StatusID={FK_StatusID}, DateCreated={DateCreated}, DateUpdated={DateUpdated}", resultItem.DepartmentID, resultItem.ShortCode, resultItem.Name, resultItem.FK_StatusID, resultItem.DateCreated, resultItem.DateUpdated);
                        return resultItem;
                    }
                    else
                    {
                        Log.Warning("No Department found with the given DepartmentID.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<Department> Departments_Insert_Transaction(Department item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Departments_Insert(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<Department> Departments_Insert(Department item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Department> Departments_Insert(Department item, SqlConnection sqlConn)
        {
            try
            {
                Department resultItem = null;
                        ...
                        , new SqlParameter() { DbType = DbType.DateTime, Direction = ParameterDirection.Input, ParameterName = "@DateUpdated", Value = item.DateUpdated }                ))
                {
                    ...
                    {
                        Log.Warning("Department failed to create.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<List<Department>> Departments_Select_All_Transaction(Department item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Departments_Select_All(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<List<Department>> Departments_Select_All(Department item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<List<Department>> Departments_Select_All(Department item, SqlConnection sqlConn)
        {
            try
            {
                List<Department> resultItem = new List<Department>();
                    ...
                    null))
                {
                    if (reader.HasRows)
                    {
                        resultItem.AddRange(await reader.TranslateAsync<Department>(Debtors_Translator.Translate_Department));
                        Log.Information("Department records found: {Count}", resultItem.Count);
                        return resultItem;
                    }
                    else
                    {
                        Log.Warning("No Department records found.");
                        return default;
                    }
                }
            }
        ...
        public static async Task<Department> Departments_Update_Transaction(Department item, string connectionString)
        {
            try
            {
                using (var transaction = new System.Transactions.TransactionScope(System.Transactions.TransactionScopeAsyncFlowOption.Enabled))
                ...
                {
                    await sqlConn.OpenAsync();
                    var result = await Departments_Update(item, sqlConn);
                    transaction.Complete();
                    return result;
                }
            }
        ...
        public static async Task<Department> Departments_Update(Department item, string connectionString)
        {
            try
            {
                using (SqlConnection sqlConn = SqlClient.CreateInstance(connectionString))
        ...
        public static async Task<Department> Departments_Update(Department item, SqlConnection sqlConn)
        {
            try
            {
                Department resultItem = null;
                        ...
                        , new SqlParameter() { DbType = DbType.DateTime, Direction = ParameterDirection.Input, ParameterName = "@DateUpdated", Value = item.DateUpdated }                ))
                {
                    ...
                    {
                        Log.Warning("Department failed to update.");
                        return default;
                    }
                }
            }
